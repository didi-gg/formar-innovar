...
class RandomForestPipeline:
    """
    Pipeline independiente para Random Forest con análisis completo y tuning de hiperparámetros.
    
    Características:
    - Encoding categórico automático
    - Imputación con mediana
    - Sin escalado (Random Forest no lo necesita)
    - Tuning de hiperparámetros (n_estimators, max_depth, min_samples_split)
    ...
    def __init__(self, random_state: int = 42):
        """
        Inicializa el pipeline de Random Forest.
    ...
    def _create_pipeline(self) -> Pipeline:
        """
        Crea el pipeline completo de Random Forest.
        ...
        # 3. Modelo Random Forest (sin scaler - no es necesario)
        steps.append(('regressor', RandomForestRegressor(random_state=self.random_state)))
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series) -> 'RandomForestPipeline':
        """
        Entrena el modelo Random Forest con tuning de hiperparámetros.
        ...
        Returns:
            self
        """
        print(f"=== Entrenando Random Forest con Tuning ===")
    ...
    def _extract_feature_importance(self):
        ...
        # Obtener importancia del modelo Random Forest
