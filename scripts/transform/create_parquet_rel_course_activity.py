...
sections_file = "../../data/processed/parquets/Course/mdlvf_course_sections.parquet"
output_file = "../../data/processed/parquets/Course/activities_section_mapping.parquet"

# Conexión DuckDB
con = duckdb.connect()


def create_parquet_rel_course_activity():
...
if __name__ == "__main__":
    create_parquet_rel_course_activity()
