...
class StudentsDataCleaner:
    def __init__(self, dataframe):
        ...
        self.replacements = {
            ...
            'nee': {'SÍ': 'Si'},
            'enfermedades': {'SÍ': 'Si'},
            'medio_transporte': {'Vehiculo privado':'Vehículo privado', 'Motocicleta': 'Vehículo privado', 'Moto':'Vehículo privado'},
        }
        ...
        self.mapeo_vocacional = {
            'Deportes': ['DEPORTISTA', 'GIMNASTA', 'FUTBOLISTA', 'PATINADORA', 'PATINADOR', 'ATLETISMO',
                         'JUGADORA DE PING PONG', 'CICLISTA', 'TENISTA', 'KARATE PROFESIONAL',
                         'ENTRENADORA DE VOLEIBOL', 'FUTBOLISTA PROFESIONAL','PILOTO DE CARRERAS', 'EMPRESARIO Y FUTBOLISTA', 'DOCTOR Y FUTBOLISTA',
                         'VETERINARIA POSIBLEMENTE', 'FUTBOLISTA O VETERINARIO', 'FUTBOLISTA Y POLICIA'],

            'Ciencias de la Salud': ['DOCTOR', 'DOCTORA', 'MEDICINA', 'PEDIATRA', 'PEDIATRIA', 'MÉDICO', 'MEDICO',
                                     'MEDICO CARDIOLOGO', 'MEDICINA (TRAUMATOLOGÍA)', 'ENFERMERA', 'INVESTIGADORA',
                                     'MEDICINA Y ADM DE EMPRESAS', 'MEDICA O INGENIERIA CIVIL'],

            'STEM': [
                # Ingenierías
                'ING EN SISTEMAS', 'INGENIERO', 'INGENIERO DE SISTEMA', 'INGENIERO FORESTAL', 
                'INGENIERO DE SISTEMAS', 'INGENIERO CIVIL', 'INGENIERO CIVIL, MILITAR', 
                'INGENIERO O ARQUITECTO', 'INGENIERÍA DE SISTEMAS', 'INGENIERIA', 
                'INGENIERIA INDUSTRIAL', 'INGENIERO MECATRÓNICO', 'INGENIERIA MECANICA', 
                'INGENIERIA MULTIMEDIA',
                
                # Programación y Tecnología
                'PROGRAMADOR', 'PROGRAMACION DE SISTEMAS',
                
                # Ciencias
                'CIENTÍFICA', 'CIENTIFICO', 'CIENTÍFICO', 'ECONOMISTA', 'ASTRONAUTA', 'VETERIANARIA',
                
                # Ciencias Biológicas y Afines
                'VETERINARIA', 'VETERINARIO', 'BIOLOGA MARINA', 'BIOLOGIA MARINA', 
                'GÉNETICA', 'ZOOTECNISTA', 'PALEONTÓLOGO', 'PALEONTOLOGO', 'BIÓLOGO',
                'ARQUEOLOGA MARINA', 'ECOLOGISTA',
                
                # Otros STEM
                'ROBÓTICA Y BAILE'
            ],

            'Arte y Entretenimiento': ['FUTBOLISTA Y YOUTUBER', 'ARTÍSTA MÚSICAL', 'CANTANTE, POLICIA', 
                'ACTRIZ O BAILARINA PROFESIONAL',
                'MUSICA', 'YOUTUBER', 'ACTOR', 'MAGO', 'ARTISTA', 'BAILARINA', 'CANTANTE', 'VIOLINISTA',
                                       'PINTORA', 'YOTUBER', 'YOUTOBER', 'MÚSICO', 'MUSICO', 'ACTRIZ', 'MODELO',
                                       'ARTISTA MÚSICAL', 'ARTÍSTA', 'ARTÍSTA PLÁSTICA', 'ARTES ESCENICAS',
                                       'ARTES VISULAES', 'TATUADORA'],

            'Sociales y Humanidades': ['ABOGADA/INGIERA/ MODELO', 'DERECHO O PSICOLOGÍA', 'PUBLICIDAD DIGITAL',
                'ABOGADO', 'ABOGADA', 'COMUNICADORA SOCIAL', 'PUBLICISTA', 'CONTADOR PÚBLICO',
                                       'DOCENTE', 'PROFESORA', 'PROFESOR', 'DOCENTE DE DEPORTES',
                                       'ADMINISTRADO DE EMPRESAS', 'NEGOCIOS INTERNACIONALES O DISEÑO GRAFICO',
                                       'NEGOCIOS IINTERNACIONALES', 'PSICÓLOGA', 'DERECHO', 'CRIMINALISTICA',
                                       'CRIMINALISTA', 'FISCAL DE MENORES', 'IDIOMAS', 'REPORTERA', 'PSICILOGA', ''],

            'Diseño y Arquitectura': ['DISEÑADORA DE MODAS O PSICOLÓGA',
                'DISEÑO INDUSTRIAL', 'DISEÑO INDSUTRIAL', 'DISEÑADOR INDUSTRIAL', 'DISEÑADOR GRAFICO',
                                      'DISEÑADORA DE MODAS', 'ARQUITECTO', 'ARQUITECTA', 'ARQUITECTCA',
                                      'DISEÑADOR GRÁFICO', 'DISEÑADORA GRÁFICA', 'DISEÑADORA DE INTERIORES',
                                      'DISEÑADORA DE INTERIORES, ARQUITECTA'],

            'Negocios y Emprendimiento': ['EMPRESARIO', 'EMPRESARIA', 'EMPREARIA', 'COMERCIANTE', 'NEGOCIOS INTERNACIONALES',
                                          'GASTRONOMIA', 'GASTRÓNOMO', 'CHEF', 'COCINERO', 'INDEPENDIENTE', 'EMPRENDEDOR'],

            'Seguridad y Fuerzas Armadas': ['MILITAR', 'BOMBERO', 'POLICIA', 'AZAFATA', 'AUXILIAR DE VUELO',
                                            'PILOTO', 'MILITAR O ASTROFÍSICO', 'TAXISTA'],

            'Indefinido o No Sabe': ['AUN NO SABE', 'AÚN NO SABE', 'NO SABE', 'NO', 'NO DEFINIDO', 'NO SABE AÚN', 'NO SABE AUN',
                                     'NO LO TIENE DEFINIDO', 'NINGUNA', 'NO SABES']
        }
    ...
    def categorize_family_convivence(self, valor):
        ...
        palabras_clave = {
            ...
            'otros': [
                'hermano', 'hermana', 'hermanos', 'abuelo', 'abuela', 
                'tío', 'tia', 'tia', 'primo', 'prima', 'cuñado', 'cuñada',
                'padrastro', 'madrastra', 'tios', 'tías', 'tias'
            ],
        }
    ...
    def categorize_extracurricular_activities(self, actividad):
        ...
        deportes_ind = ['equitación', 'campamento', 'montar cicla', 'actividades fisicas', 'gimnasio', 'patinae', 'natación', 'natacion', 'tenis', 'ciclismo', 'atletismo', 'karate',
                        'taekwondo', 'pilates', 'golf', 'motocross', 'patinaje', 'gimnasia',
                        'bicicleta', 'tennis']
